...
> Agent P0/P1/P2 已提供模型网关、动态访谈、可确认记忆、宠物孵化、匹配算法与 10 用户全流程 Demo（`python -m app.demo`）。匹配与测试清单见 [docs/P2_MATCHING_DEMO.md](docs/P2_MATCHING_DEMO.md)，P0/P1 说明见 [docs/P0_P1_OVERVIEW.md](docs/P0_P1_OVERVIEW.md) 与 [docs/P0_AGENT_FOUNDATION.md](docs/P0_AGENT_FOUNDATION.md)。
